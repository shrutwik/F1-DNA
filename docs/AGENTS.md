...
3. **Claude Code** — See [`CLAUDE.md`](CLAUDE.md) and [`POLICY.md`](POLICY.md).
4. **Subagents** — Full prompts: [`implementer-prompt.md`](implementer-prompt.md), [`spec-reviewer-prompt.md`](spec-reviewer-prompt.md), [`code-quality-reviewer-prompt.md`](code-quality-reviewer-prompt.md). Orchestrator passes complete task text; subagents do not read plans from disk. Workflow skill: [obra/superpowers](https://github.com/obra/superpowers).
